...
st.markdown("<h3 style='text-align: center; color: darkgreen;'> A System to Recognize Tree Species in Timber Forest Management Based on Bark Images, Amazon, Brazil</h3>", unsafe_allow_html=True)
